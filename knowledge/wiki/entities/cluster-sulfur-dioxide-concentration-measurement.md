---
title: "Sulfur Dioxide Concentration Measurement Cluster"
type: entity
sources:
  - raw/specs/07-5123-07-ZigbeeClusterLibrary_Revision_7-1.pdf
tags: [zigbee, cluster, zcl, zcl-rev7, measurement, sulfur-dioxide, concentration]
created: 2026-05-10
updated: 2026-05-10
cluster_id: "0x0416"
status: reviewed
...
# Sulfur Dioxide Concentration Measurement Cluster (0x0416)

## 概述

Sulfur Dioxide Concentration Measurement Cluster（Cluster ID `0x0416`）属于 ZCL Rev 7 的 Measurement and Sensing 功能域，章节定位为 4.13。Sulfur Dioxide Concentration Measurement 是 Rev 7 Concentration Measurement 基础规范下的派生 cluster identifier，复用同一组 MeasuredValue/Min/Max/Tolerance 语义。
...
|------|------|
| Cluster ID | `0x0416` |
| 名称 | Sulfur Dioxide Concentration Measurement |
...
- `0x0416` 的权威定义来自 ZCL Rev 7；测试规范是 certification 要求，不能直接替代协议行为。
